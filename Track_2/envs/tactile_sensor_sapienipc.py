...
Track_2_path = os.path.join(script_path, "..")
sys.path.append(script_path)
sys.path.append(Track_2_path)
...
class TactileSensorSapienIPC:
    def __init__(
        ...
        meta_file = Path(Track_2_path) / "assets" / meta_file
...
class VisionTactileSensorSapienIPC(TactileSensorSapienIPC):
    ...
    def _gen_marker_grid(self):
        ...
        ) * np.random.rand(1)[0] + self.marker_interval_range[
            0
        ]  # 2.0625
